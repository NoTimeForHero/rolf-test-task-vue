/* eslint-disable */
// Downloaded from: https://raw.githubusercontent.com/nfort/yup-locale-ru/master/locale.js
// TODO: Правильные числительные для русского языка
...
export let mixed = {
  ...
  notType: ({ path, type, value, originalValue }: {path: any, type: any, value: any, originalValue: any}) => {
